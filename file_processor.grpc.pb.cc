...
FileProcessorService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  : channel_(channel), rpcmethod_ConvertToTXT_(FileProcessorService_method_names[0], options.suffix_for_stats(),::grpc::internal::RpcMethod::BIDI_STREAMING, channel)
  , rpcmethod_ConvertImageFormat_(FileProcessorService_method_names[1], options.suffix_for_stats(),::grpc::internal::RpcMethod::BIDI_STREAMING, channel)
  , rpcmethod_ResizeImage_(FileProcessorService_method_names[2], options.suffix_for_stats(),::grpc::internal::RpcMethod::BIDI_STREAMING, channel)
  {}
...
::grpc::ClientReaderWriter< ::file_processor::FileChunk, ::file_processor::FileChunk>* FileProcessorService::Stub::ConvertImageFormatRaw(::grpc::ClientContext* context) {
...
void FileProcessorService::Stub::async::ConvertImageFormat(::grpc::ClientContext* context, ::grpc::ClientBidiReactor< ::file_processor::FileChunk,::file_processor::FileChunk>* reactor) {
...
::grpc::ClientAsyncReaderWriter< ::file_processor::FileChunk, ::file_processor::FileChunk>* FileProcessorService::Stub::AsyncConvertImageFormatRaw(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq, void* tag) {
...
::grpc::ClientAsyncReaderWriter< ::file_processor::FileChunk, ::file_processor::FileChunk>* FileProcessorService::Stub::PrepareAsyncConvertImageFormatRaw(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq) {
...
::grpc::ClientReaderWriter< ::file_processor::FileChunk, ::file_processor::FileChunk>* FileProcessorService::Stub::ResizeImageRaw(::grpc::ClientContext* context) {
...
void FileProcessorService::Stub::async::ResizeImage(::grpc::ClientContext* context, ::grpc::ClientBidiReactor< ::file_processor::FileChunk,::file_processor::FileChunk>* reactor) {
...
::grpc::ClientAsyncReaderWriter< ::file_processor::FileChunk, ::file_processor::FileChunk>* FileProcessorService::Stub::AsyncResizeImageRaw(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq, void* tag) {
...
::grpc::ClientAsyncReaderWriter< ::file_processor::FileChunk, ::file_processor::FileChunk>* FileProcessorService::Stub::PrepareAsyncResizeImageRaw(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq) {
...
::grpc::Status FileProcessorService::Service::ConvertImageFormat(::grpc::ServerContext* context, ::grpc::ServerReaderWriter< ::file_processor::FileChunk, ::file_processor::FileChunk>* stream) {
  (void) context;
  (void) stream;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
}

::grpc::Status FileProcessorService::Service::ResizeImage(::grpc::ServerContext* context, ::grpc::ServerReaderWriter< ::file_processor::FileChunk, ::file_processor::FileChunk>* stream) {
  (void) context;
  (void) stream;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
}
